...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if (card == adventurer)  {
      return play_adventurer(state, drawntreasure, currentPlayer, z);
  }
    ...
    return -1;
      ...
      return play_mine(currentPlayer, state, choice1, choice2, handPos);
  }
	...
	if (tributeRevealedCards[i] == copper || tributeRevealedCards[i] == silver || tributeRevealedCards[i] == gold){//Treasure cards
      ...
      return play_ambassador(currentPlayer, state, choice1, choice2, handPos);
}
	...
	if (i != currentPlayer){
      ...
      return play_treasure_map(currentPlayer, state, handPos);
}
